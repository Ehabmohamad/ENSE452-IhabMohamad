...
//*********************** Phase 1 ************************************/
  ...
  //uint8_t rxData[1];  // to hold received data
...
//*********************** Phase 2 ************************************/
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  ...
	  //**************************** Phase 1 Get the Serial Port Working and confirming the connection with PuTTY **********************************/
	  	// Transmit message
	  	//HAL_UART_Transmit(&huart2, msg, strlen((char*)msg), HAL_MAX_DELAY);

	  	// An if function to receive one byte of data using the HAL_UART_Receive() function
